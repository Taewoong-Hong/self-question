      ...
      <div className="absolute top-14 lg:top-0 lg:left-64 left-0 right-0 z-50 bg-white/90 dark:bg-zinc-950/90 backdrop-blur-sm border-b border-zinc-200 dark:border-zinc-800">
        <div className="max-w-7xl mx-auto px-4 py-4">
          <div className="flex items-center justify-between">
            ...
            <button
              onClick={() => router.push('/guestbook/write')}
              className="relative p-3 border border-zinc-300 dark:border-zinc-700 text-zinc-700 dark:text-zinc-100 rounded-lg hover:border-zinc-400 dark:hover:border-zinc-500 hover:bg-zinc-100 dark:hover:bg-zinc-800/50 transform hover:-translate-y-0.5 transition-all duration-200"
              title="메모 남기기"
            >
