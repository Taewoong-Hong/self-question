...
export default function GuestbookPage() {
  ...
  const handleCreateNote = async (content: string, nickname?: string, password?: string) => {
    try {
      const newNote = await guestbookApi.create({
        content,
        color: selectedColor,
  ...
  return (
    <div className="min-h-screen">
      ...
      <div className="mb-8">
        <div className="flex items-center justify-between">
          <div className="pl-[3px]">
            ...
            <p className="text-zinc-400 mt-1">자유롭게 메모를 남겨주세요</p>
          </div>
          <button
      ...
      {/* 방명록 보드 */}
      <div className="relative bg-zinc-900/30 border border-zinc-800 rounded-xl" style={{ height: '80vh', minHeight: '600px' }}>
        {loading ? (
