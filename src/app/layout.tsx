...
function LayoutContent({ children }: { children: React.ReactNode }) {
  ...
  return (
    <html lang="ko" suppressHydrationWarning className={mounted ? (theme === 'dark' ? 'dark' : '') : 'dark'}>
      <body className={`${inter.className} bg-white dark:bg-zinc-950 text-zinc-900 dark:text-zinc-100 min-h-screen transition-colors duration-200`} suppressHydrationWarning>
